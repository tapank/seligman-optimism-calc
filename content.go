...
This is a widely used test for depression, developed by Lenore Radloff at the
Center for Epidemiological Studies of the National Institute of Mental Health in
the USA. This test, called the CES-D (Center for Epidemiological Studies -
Depression), covers all the symptoms of depression.

Important! Select the answer which best describes how you have felt over THE
PAST WEEK.
